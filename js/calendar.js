var visit_calendar = (metrics, visit_color) => {
    ...
    fetch('./data/calendar.json?date'+new Date()).then(data => data.json()).then(res => {
      ...
      append_div_visitcalendar(document.getElementById('calendar_container'), html);
  ...
  (function init () {
    ...
    append_div_visitcalendar(calendar_container, loading_visit(visit_color[4]));
